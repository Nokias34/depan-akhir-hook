...
export default class Home extends Component{
    ...
    constructor(props){
        ...
        this.header = [
            ...
            { title: "Judul", prop: "title", sortable: true, filterable: true },
            { title: "Harga", prop: "description", sortable: true, filterable: true },
            { title: "Developer", prop: "developer", sortable: true, filterable: true },
    ...
    componentDidMount(){
        ...
        GameDataService.getPublished().then(
            response => {
                this.setState({
                    isLoaded: true,
                    items: response.data
